                      ...
                      {simState === 'IN_CALL' && (
                        <div className="flex-1 flex flex-col items-center justify-between py-2">
                          ...
                          <div className="flex flex-col items-center my-auto">
                            ...
                            <span className="text-xs text-slate-400">Speaker ID: #{currentPartnerId}</span>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="p-4 rounded-2xl bg-gradient-to-b from-[#111622] to-[#0c0f16] border border-slate-800 flex items-center justify-between">
                                  ...
                                  {profileImage && (
                                    <div className="mt-1">
                                      <button
                                        ...
                                        className="text-[10px] text-red-400/80 hover:text-red-300 font-medium transition-colors"
                                      >
                                        Remove photo
                                      </button>
                                    </div>
                              ...
                              <button
                                ...
                                className="px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-xs font-semibold text-emerald-400 border border-slate-700 self-start mt-1"
                              >
                            ...
                            <div className="grid grid-cols-3 gap-2 text-center">
                              <div className="p-2.5 rounded-xl bg-slate-900/80 border border-slate-800">
                                ...
                                <span className="text-sm font-bold text-emerald-400 font-mono">145 min</span>
                              </div>
                              <div className="p-2.5 rounded-xl bg-slate-900/80 border border-slate-800">
                                <span className="text-[10px] text-slate-400 block">Calls Taken</span>
                                <span className="text-sm font-bold text-white font-mono">28</span>
                              </div>
                              <div className="p-2.5 rounded-xl bg-slate-900/80 border border-slate-800">
